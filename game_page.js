...
function send(){
    ...
    var lineat = get_word.toLowerCase()

    var lineat1 = word.lineat(1)

    var divide = Math.floor(word.length/2)
    var lineat2 = word.lineat1(divide);

    var subtract = word.length - 1
    var lineat3 = word.lineat1(subtract);
    ...
    var question_word = "<h4 id='word_display'> Q."+removelineat3"</h4>"
